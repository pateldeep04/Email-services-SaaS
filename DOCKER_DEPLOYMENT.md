...
# Option A: Connect to External Cloud Database (e.g., MongoDB Atlas)
MONGO_URI=mongodb+srv://<username>:<password>@cluster0.mongodb.net/mailbridge?retryWrites=true&w=majority

# Option B: Connect to local containerized MongoDB
